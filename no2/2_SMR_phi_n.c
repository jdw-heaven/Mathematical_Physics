...
double m_mmn(int E_m1, double E_x1, int E_m2, double E_x2, double r, double th){
    return gsl_sf_bessel_Jn(E_m1,E_x1*r)*cos(E_m1*th)*(1/(1+0.2*gsl_sf_bessel_Jn(1,3.831706*r)*cos(th)))*gsl_sf_bessel_Jn(E_m2,E_x2*r)*cos(E_m2*th)*r;
}
