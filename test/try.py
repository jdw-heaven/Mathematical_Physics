...
# 文件路径模板
file_template = '/home/heaven/Desktop/doc/Mathematical_Physics/test/data/u{}.txt'

# 读取特征值和x坐标
with open('/home/heaven/Desktop/doc/Mathematical_Physics/test/data/eigenvalue.txt', 'r') as file:
    eigenvalues = list(map(float, file.read().split()))
with open('/home/heaven/Desktop/doc/Mathematical_Physics/test/data/x.txt', 'r') as file:
    x = list(map(float, file.read().split()))
with open('/home/heaven/Desktop/doc/Mathematical_Physics/test/data/y.txt', 'r') as file:
...
# 调整子图之间的间距
plt.tight_layout()
fig.suptitle(f'Question2,SMR,rho1=0 ,dots = 30401')
# 显示图形
plt.show()